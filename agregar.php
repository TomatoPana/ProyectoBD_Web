        ...
        <div>
          <div class="login-form">
            <form action="/examples/actions/confirmation.php" method="post">
              ...
              <div class="mb-3">
                <label for="formFile" class="form-label">ingrese la imagen del juego</label>
                <input class="form-control" type="file" id="formFile">
              </div>
              <div class="form-group purple-border">
                <label for="exampleFormControlTextarea4">descripcion del juego</label>
                <textarea class="form-control" id="exampleFormControlTextarea4" rows="3"></textarea>
              </div>
              <p class="hint-text">ingrese el nombre del empleado que realizara el cambio</p>
              <div class="form-group">
                <input type="text" class="form-control" name="user" placeholder="Nombre del empleado" required="required">
              </div>
              <p class="hint-text">ingrese el nombre del juego</p>
              <div class="form-group">
                <input type="text" class="form-control" name="name" placeholder="nombre del juego" required="required">
              </div>
              <p class="hint-text">ingrese el precio del juego</p>
              <div class="form-group">
